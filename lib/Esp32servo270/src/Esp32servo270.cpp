...
bool Esp32servo270::IsValidMoveTo(int iMoveTo)
{
    ...
    if (iMoveTo >= getAttachMoveUsMin() && iMoveTo <= getAttachMoveUsMax())
    {
...
int Esp32servo270::getAttachMoveUsMin() { return this->attachMoveUsMin; }
int Esp32servo270::getAttachMoveUsMax() { return this->attachMoveUsMax; }
