...
...................
    ...
    int attach(attachEsp32Pin );
        ...
        they will be used
        Set attachMoveDegreeMin=0;
        Set attachMoveDegreeMax= attachDatasheetDegreeMax
  ...
  2.3 Atach full parameters
   int attach(int attachEsp32Pin, int attachDatasheetUsMin, int attachDatasheetUsMax, int attachDatasheetDegreeMax, int attachMoveDegreeMin, int attachMoveDegreeMax);
        
        enforced attachMoveDegreeMin  by #define US_DATASHEET_MinLimit 400  
        enforced attachMoveDegreeMax  by #define US_DATASHEET_MaxLimit 2500 
        enforced degree by define:   #define DEGREE_DATASHEET_MinLimit 90 and  #define DEGREE_DATASHEET_MaxLimit 270
        enforced attachMoveDegreeMin=0;
        enforced attachMoveDegreeMax= attachMoveDegreeMax
...
public:
    ...
    int getAttachMoveDegreeMax();
    int getAttachMoveDegreeMin();
int getAttachMoveUsMin();
int getAttachMoveUsMax();
private:
    ...
    int attachMoveDegreeMin = 0;
    int attachMoveDegreeMax = ATTACH_DATASHEET_DEGREE_MAX_DEFAULT;
    int attachMoveUsMin=0; // calculate when attach from map attachMoveDegreeMin
    int attachMoveUsMax=0; // calculate when attach from map attachMoveDegreeMax
};
#endif
