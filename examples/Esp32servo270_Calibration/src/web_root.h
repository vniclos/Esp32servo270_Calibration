...
<div>
  	...
  	<fieldset>
  		<legend>Servo Configuration</legend>
  		
  		<div>
  	  <label for="scnHardServoPin" class="fieldTitle">Attached to Esp32 pin</label> 
      ...
      <h4>Acording datasheet of hardaware servo</h4>		
  		<div>
      <label for="scnDatasheetMinUs">Minimum pulse µs (Micro secconds)</label> 
      <input id="scnDatasheetMinUs" placeholder="500" type="number"  maxlength="3" size:"3" onkeypress="return onlyNumberKey(event)"  value="600"/>
      ...
      <div>
      <label for="scnDatasheetMaxUs">Maximum pulse µs</label>  
      <input id="scnDatasheetMaxUs" placeholder="2500" type="number"  maxlength="4"  size:"4"  onkeypress="return onlyNumberKey(event)"  value="2500"/>
     ...
     <div>
      <label for="scnDatasheetMaxD max Degree">Maximum turn in degrees</label>
      <input id="scnDatasheetMaxD" type="number" placeholder="180"  maxlength="3" size:"3" onkeypress="return onlyNumberKey(event)"  value="180"/>
       <button onclick="OpenModal('Start with datasshet v(Micro secconds)alue, later aujust fine. Usually one of this[90,180.270,270] degree.<br/>Note: Min=90, Max=270')">Help</button>
      <span id="scnDatasheetMaxDegreeMsg" ></span>
      </div>

    <div>
    <b>Limitation movement in the installation</b>
    ...
    <div>
      ...
      <input id="scnMoveMaxDegree" type="number" placeholder="180"  maxlength="3"  size:"3" onkeypress="return onlyNumberKey(event)" />
       <span id="scnMoveMaxDegreeMsg"></span>
  		...
  		<input id=ScnAttachButon" type="button" value="Atach" onclick="jsAtach();">
  		<input id=ScnDettachhButon" type="button" value="Detach" onclick="jsDetach();">
    <div>
      ...
      <tr><td>MG995</td ><td>180</td><td>500</td><td>2500</td><td>50Hz 20ms></tr>
...
<fieldset>
  ...
  <input id="scnMoveToSliderMicro" type="range" min="550" max="2500" value="1000" class="slider" 
...
<fieldset>
   ...
   <input id=scnBtnStatus" type="button" value="Get status" onclick="fncGetHtml('scnMsgStatus', '/status');">
   <pre><code id="scnMsgStatus"></code></pre>
</fieldset>
