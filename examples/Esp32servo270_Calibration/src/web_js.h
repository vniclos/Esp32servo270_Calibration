...
//...........................
  ...
  iValidMin=0;
  iValidMax=   document.getElementById('scnDatasheetMaxD').value; 
...
pURL=pURL+"&DataSheetMinUs="+document.getElementById("scnDatasheetMinUs").value;
pURL=pURL+"&DataSheetMaxUs="+document.getElementById("scnDatasheetMaxUs").value;
pURL=pURL+"&DataSheetMaxD="+document.getElementById("scnDatasheetMaxD").value;
pURL=pURL+"&MoveMinD="+document.getElementById("scnMoveMinDegree").value;
pURL=pURL+"&MoveMaxD="+document.getElementById("scnMoveMaxDegree").value;
document.getElementById("scnMsgConfiguration").innerHTML=pURL;
//let iSliderMax=document.getElementById("scnMoveMaxDegree").value;
//if(document.getElementById("scnDatasheetMaxD").value>document.getElementById("scnMoveMaxDegree").value);
//{
//  iSliderMax=document.getElementById("scnMoveMaxDegree").value;
//}
//document.getElementById("scnMoveToSliderDegree").max=iSliderMax;
document.getElementById("scnMoveToSliderDegree").max=document.getElementById("scnDatasheetMaxD").value;
document.getElementById("scnMoveToSliderMicro").min=document.getElementById("scnDatasheetMinUs").value;
document.getElementById("scnMoveToSliderMicro").max=document.getElementById("scnDatasheetMaxUs").value;
console.log(pURL);
fncGetHtml(pDivTarget, pURL);
}
function jsTemplate ()
